...
- Take 8 minutes to do these exercises in breakout rooms. We will then go over together
...
```{r survey_quantile_ex2a, error=TRUE}
recs_des %>%
   summarize(
      Spent=survey_quantile(x = TOTALDOL,
                            quantiles = c(.25, .75),
...
---
## `survey_ratio` Example: What is the average mean dollars per BTU spent on energy?
